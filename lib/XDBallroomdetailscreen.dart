...
class XDBallroomdetailscreen extends StatelessWidget {
  XDBallroomdetailscreen({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 100.0, middle: 0.2935),
            Pin(size: 21.0, start: 97.0),
            child: Text(
              'ID 506012013',
              style: TextStyle(
                fontFamily: 'Roboto',
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 269.0, start: 57.0),
            Pin(size: 121.0, middle: 0.2438),
          ...
          Pinned.fromPins(
            Pin(size: 211.0, start: 97.0),
            Pin(size: 33.0, start: 319.0),
            child:
                // Adobe XD layer: '✏️ Headline 5' (text)
                Text(
              'available stock',
          ...
          Pinned.fromPins(
            Pin(size: 100.0, middle: 0.7816),
            Pin(size: 21.0, start: 139.0),
            child: Text(
              'ID 506012013',
              style: TextStyle(
                fontFamily: 'Roboto',
