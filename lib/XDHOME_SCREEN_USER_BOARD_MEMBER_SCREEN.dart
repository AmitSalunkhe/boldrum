  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(start: -4.0, end: -21.0),
            Pin(size: 401.0, middle: 0.4378),
...
// background:
          ...
          Pinned.fromPins(
            Pin(size: 226.0, start: 86.0),
            Pin(size: 33.0, start: 203.0),
            child:
                // Adobe XD layer: '✏️ Headline 5' (text)
                Text(
              'APPROVED ORDERS',
          ...
          Pinned.fromPins(
            Pin(size: 218.0, start: 96.0),
            Pin(size: 33.0, start: 553.0),
            child:
                // Adobe XD layer: '✏️ Headline 5' (text)
                Text(
              'PENDING  ORDERS ',
