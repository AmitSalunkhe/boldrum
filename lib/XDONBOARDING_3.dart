...
class XDONBOARDING_3 extends StatelessWidget {
  XDONBOARDING_3({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 252.0, middle: 0.5248),
            Pin(size: 252.0, middle: 0.4942),
            child:
                // Adobe XD layer: '8iknpxuq' (shape)
                Container(
              decoration: BoxDecoration(
